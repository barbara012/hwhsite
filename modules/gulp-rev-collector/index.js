    ...
    if (ext === '.json') {
        ...
        if (_.isObject(json)) {
            ...
            Object.keys(json).forEach(function (key) {
                //if ( !_.isString(json[key]) || path.basename(json[key]).replace(new RegExp( opts.revSuffix ), '' ) !==  path.basename(key) ) { modify by hwh
            ...
            if ( dirReplacements.length ) {
                dirReplacements.forEach(function (dirRule) {
                    patterns.forEach(function (pattern) {
                        changes.push({
                            //regexp: new RegExp( '([\/\\\\\'"])' + pattern, 'g' ),// modify by hwh
