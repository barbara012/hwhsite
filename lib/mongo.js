...
exports.User = mongolass.model('User', {
  ...
  avatar: { type: 'string' },
  avatarOriginalPath: { type: 'string' },  //头像原始路径
  privilege: { type: 'number' }, // 1,2,3,4数字越高用户权限越低
...
exports.Image.index({ name: 1 }, { unique: true }).exec()// 根据用户名找到用户，用户名全局唯一
